...
if($api->check_array(['api_key','api_signature','api_version','api_type','transaction_amount','transaction_mobile','transaction_code'],$_POST)){
    if($_POST['api_type'] == 'Initiate'){
        ...
        if($_POST['api_key']==$api_key && $_POST['api_signature']==$api_sign){
            ...
            $stmt = $api->conn->prepare("INSERT INTO transactions (transaction_no, details, amount) VALUES (?,?,?)");
